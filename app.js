...
import {renderScreen,renderGrid,renderServices} from './components/sections.js';
import {initMotion} from './motion.js';
import {moduleMap} from './module-map.js';
function render(m){
 const renderers={hero:()=>renderScreen(m,renderHeader()),split:()=>renderScreen(m),campaign:()=>renderScreen(m),categories:()=>renderGrid(m),products:()=>renderGrid(m),stories:()=>renderGrid(m),services:renderServices,footer:renderFooter};
